...
class DadaOpenapi{
    ...
    public function __construct($config){
        ...
        isset($config['url_prefix']) ? $this->url_prefix = $config['url_prefix'] : '';
    ...
    public function makeRequest($data){
        ...
        $resp = $this->getHttpRequestWithPost($this->url_prefix . $this->url, json_encode($reqParams));
    ...
    public function parseResponseData($arr){
        if (empty($arr)) {
            ...
            \Think\Log::write(var_export($data, true), "INFO");
